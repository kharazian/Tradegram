...
namespace Volo.Abp.Text
{
	public static class StringExtensions
	{
        ...
        public static bool IsAbsoluteUrl(this string url)
        {
            ...
            var schemes = new string[] { Uri.UriSchemeFile, Uri.UriSchemeFtp, Uri.UriSchemeHttp, Uri.UriSchemeHttps, Uri.UriSchemeMailto, Uri.UriSchemeNetPipe, Uri.UriSchemeNetTcp };
            var retVal = schemes.Any(x=> url.StartsWith(x, StringComparison.InvariantCultureIgnoreCase));
            return retVal;
        }
