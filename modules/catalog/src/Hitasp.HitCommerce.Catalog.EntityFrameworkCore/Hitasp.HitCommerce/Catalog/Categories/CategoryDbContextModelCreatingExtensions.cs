    ...
    public static class CategoryDbContextModelCreatingExtensions
    {
            ...
            Action<CatalogModelBuilderConfigurationOptions> optionsAction = null)
        {
            ...
            builder.Entity<Category>(b =>
            {
                ...
                b.Property(x => x.SpaceId).IsRequired(false).HasColumnName(nameof(Category.SpaceId));
                b.Property(x => x.CategoryTemplateId).IsRequired().HasColumnName(nameof(Category.CategoryTemplateId));
                b.Property(x => x.CategoryInfoId).IsRequired().HasColumnName(nameof(Category.CategoryInfoId));
                b.Property(x => x.CategoryMetaId).IsRequired().HasColumnName(nameof(Category.CategoryMetaId));
                b.Property(x => x.CategoryPublishingInfoId).IsRequired().HasColumnName(nameof(Category.CategoryPublishingInfoId));
