...
{
    public class ManufacturerMeta : Entity<Guid>
    {
        ...
        protected ManufacturerMeta()
        {
        }

        internal ManufacturerMeta(Guid categoryId) : base(categoryId)
        {
        }
        ...
        public void SetMetaData(string metaTitle, string metaKeywords, string metaDescription)
        {
            ...
            {
                throw new ArgumentException($"Meta Title can not be longer than {ManufacturerConsts.MaxMetaTitleLength}");
            }
            
            if (metaKeywords.Length >= ManufacturerConsts.MaxMetaKeywordsLength)
            {
                throw new ArgumentException($"Meta Keywords can not be longer than {ManufacturerConsts.MaxMetaKeywordsLength}");
            }
            
            if (metaDescription.Length >= ManufacturerConsts.MaxMetaDescriptionLength)
            {
                throw new ArgumentException($"Meta Description can not be longer than {ManufacturerConsts.MaxMetaDescriptionLength}");
            }
